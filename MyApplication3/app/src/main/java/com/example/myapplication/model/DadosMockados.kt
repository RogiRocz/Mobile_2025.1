...
object DadosMockados {
    ...
    val listaDePerguntasFrequentes = listOf(
        ...
        "Posso filtrar receitas por tipo de dieta?",
        "Como funciona a funcionalidade de lista de compras?",
        "Existem opções para receitas vegetarianas ou veganas?",
        "Como faço para relatar um erro ou dar um feedback?",
        "O aplicativo funciona offline?",
        "Posso personalizar minhas preferências alimentares?",
        "As receitas são verificadas por nutricionistas?",
        "Como eu atualizo meus dados pessoais?",
        "Existe uma seção de receitas mais populares?",
        "Como compartilho uma receita com amigos?"
    )
}